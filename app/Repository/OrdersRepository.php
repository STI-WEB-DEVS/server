...
class OrdersRepository
{
    ...
    $customer = Customer::findOrFail($payload['customer_id']);
        ...
        foreach ($payload['items'] as $item) {
            ...
            $itemsResolved[] = ['product' => $product, 'quantity' => $item['quantity']];
        }
        ...
        foreach ($itemsResolved as $resolved) {
            OrderItem::create([
                'order_id'   => $order->id,
                'product_id' => $resolved['product']->id,
                'quantity'   => $resolved['quantity'],
                'unit_price' => $resolved['product']->price,
            ]);

            $resolved['product']->decrement('quantity', $resolved['quantity']);
        }
