...
class OrderRepository
{
    ...
    public function createWithItem(array $orderData, array $itemData)
{
...
public function getByCustomerUuid(string $uuid)
{
    return Order::whereHas('customer', function($q) use ($uuid) {
        $q->where('uuid', $uuid);
    })->with('items')->get();
}
}